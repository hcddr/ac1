; File Name   :	d:\hobby3\ac1-2010\edas\EDAS4_4000_544F_4000.bin
; Format      :	Binary file
; Base Address:	0000h Range: 4000h - 5450h Loaded length: 1450h
...
; e2.bin ist edas auf 1000 gelinkt
; Binärvergleich e2.bin zeap20.bin
; Bereich unk_40A8..sub_4473-4 entspricht fast 100% zeap20
; Ausnahme 3 Byte 43BF
...
off_4006:	dw unk_6000		; BUFBEG	Editierpufferanfang
...
loc_4809:	ld	hl, (word_550C)	; MC-Adr.
		...
		bit	6, (iy+0)
		jr	nz, loc_483E
		ld	bc, loc_5400	; Bereich loc_5400..unk_5600
		ld	de, unk_5600
...
COLD:		call	sv_init		; Sprungverteiler init
		ld	hl, 0FFFFh
...
word_54B0:      equ 54B0h		; C: Anfangszeile
word_54B2:      equ 54B2h		; C: Endezeile
word_54B4:      equ 54B4h		; C: Zielzeile
word_54B6:      equ 54B6h
word_54B8:      equ 54B8h		; Adresse Anfang Sekundärquelle (SEC)
word_54BA:      equ 54BAh		; Adresse Ende Sekundärquelle (SEC)
word_54BC:      equ 54BCh		; Adresse Assemblieren Anfang
word_54BE:      equ 54BEh		; Adresse Assemblieren Ende
unk_54C0:       equ 54C0h		; Beginn Eingabepuffer Zeile 61 Bytes
unk_54FF:       equ 54FFh		; Buffer f. Code (down)

;
BUFBEG:		equ 5500h		; Anfangsdresse Textpuffer
BUFEND:		equ 5502h		; Endadresse Textpuffer
unk_5504:       equ 5504h		; Druckerausgabe
byte_5507:      equ 5507h		; Assembleroptionen
byte_5508:      equ 5508h		; Ausgabeverzögerung Druck
byte_5509:	equ 5509h		; Ausgabeverzögerung BWS
mc_ofs:      	equ 550Ah		; offset for code generation
word_550C:      equ 550Ch		; letzte Adresse MC+1 (END:)
word_550E:      equ 550Eh		; ENTry-Adresse
word_5510:      equ 5510h		; aktuelle Zeilennummer
word_5512:      equ 5512h       	; ausgegebene Zeilennummer
byte_5514:      equ 5514h		; Seitengröße bei Schirmausgabe (25 Zeilen)
unk_5515:       equ 5515h		; kdotab
word_5517:      equ 5517h		; unk_40AA Parse Tree Mnemonics
word_5519:      equ 5519h		; unk_428F Parse Tree Register
word_551B:      equ 551Bh		; unk_42F4 Tokenklassen Register,Flags
unk_551D:       equ 551Dh		; Tabelle Zeichenklassen Spezialzeichen
unk_552D:       equ 552Dh       	; sonstiges Spezialzeichen (akt. Zeichen)
unk_5530:       equ 5530h		; 6 Zeichen Marke
unk_556E:       equ 556Eh		; Find Zeichenkette, Buffer bis unk_552D (41H Zeichen)
					; Textanfang ('/'), Buffer enthält den Text revers, absteigende Adr!
unk_556F:       equ 556Fh		; 6 Zeichen vom Anfang des Buffers (Kopf), f. REUSE
p_BUFBEG:	equ 5575h		; Sicherung BUFBEG f. REUSE
unk_5577:       equ 5577h		; Seitengröße
word_5578:      equ 5578h       	; Adr. Ret-Funktion nach Fehler
unk_557A:       equ 557Ah
word_557C:      equ 557Ch
word_5582:      equ 5582h
byte_5584:      equ 5584h		; Schrittweite (RENUM, INUM)
word_5585:      equ 5585h
word_5587:      equ 5587h
word_5589:      equ 5589h
unk_559B:       equ 559Bh       	; loc_4D0E  - Ausgabe Enter+ggf. Abbruch bei Strg-C 
					; o. loc_4CA2 - Ausgabe in Speicher (ARG3)
unk_559E:       equ 559Eh		; Kdo-Buchstabe
byte_559F:      equ 559Fh		; Anzahl Kdo.Argumente
orig_sv:	equ 55A0h		; Merker für orig. Sprungverteiler
					; 12h Byte
errcnt:      	equ 55B2h		; Fehlerzähler
unk_55B4:       equ 55B4h		; inch0 Repeat-Timer
;iy-12h
;iy-0Fh	; 55EF
...
word_55F2:      equ 55F2h
unk_55F6:       equ 55F6h
byte_55FE:	equ 55FEh		; IY, TOP Stack
unk_55FF:       equ 55FFh		; IY+1 = Assembleroptionen
